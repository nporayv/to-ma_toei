...
//
// ★保守の注意★
//   運賃改定は思ったより頻繁にある(JR東日本 2026年3月14日に電車特定区間廃止、
...
//     東京メトロ … 公式の普通券運賃表で全帯を確認済み(2026-08-31)
//     都営      … 無料乗車券の対象なので実費には影響しない
...
const FARE_TABLES = {
  // JR東日本 幹線(きっぷ運賃)。
  // 東京近郊の「電車特定区間」と「山手線内」の運賃区分は2026年3月14日に廃止され、
  ...
  //   1〜6km:180 / 7〜11km:210 / 12〜19km:260 / 20〜27km:300 / 28〜40km:330(上限)
  //   公式は「1km未満を1kmに切り上げてから」帯に当てるが、下の km <= 上限 と同じ結果になる。
  //   ★以前は上限を340円としており、10円high(安全側)だが誤りだった。
  //   なお次の特殊区間は未実装。いずれも実際より高く出る=安全側:
  //     千代田線 綾瀬〜北千住 160円 / 南北線 目黒〜白金高輪 180円
  metro: [[6, 180], [11, 210], [19, 260], [27, 300], [Infinity, 330]],
