...
const CASES = [
  ...
  // 2026-08-31に乗換案内サービスで実運賃を確認して追加。初乗り帯と、それまで
  // 検証点の無かった4〜6km帯(200円)を押さえる。IC運賃はきっぷ運賃以下になる。
  { op: "jr", from: "中野",         to: "東中野",   km: 1.9,  fare: 160, src: "実運賃 2026-08-31 (IC155)" },
  { op: "jr", from: "渋谷",         to: "新宿",     km: 3.4,  fare: 200, src: "実運賃 2026-08-31 (IC199)" },
  { op: "jr", from: "三鷹",         to: "新宿",     km: 13.8, fare: 260, src: "実運賃 2026-08-31 (IC253)" },
