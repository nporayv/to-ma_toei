...
EDGE_KM = {
    ...
    # JR京葉線(秋葉原からの累計。東京駅を基準としたJR営業キロから計算)。
    # 秋葉原→舞浜は15km超の推定だったため350円になっていたが、実際は14.9km。
    # JR東日本の営業キロ程表から取得(2026年現在)。
    # https://www.jreast.co.jp/
    "11326": {
        "秋葉原": 0, "八重洲": 0.6, "東京": 2.2, "有楽町": 3.4,
        "新木場": 9.4, "葛西": 12.3, "浦安": 14.3, "舞浜": 14.9,
    },
}
